...
position = (300,500)
# 배경 이미지 불러오기
background = pygame.image.load("/Users/imin-ug/Python/게임프로그래밍/파이게임/겜프프로젝트/게임리소스/할로윈_테마_배경.png")
background_left = pygame.transform.flip(background, True, False)

mySound = pygame.mixer.Sound( "/Users/imin-ug/Python/게임프로그래밍/파이게임/겜프프로젝트/진짜제출폴더임/음악파일/할로윈.mp3" )
...
def main():
    ...
    pygame.mixer.music.load( "/Users/imin-ug/Python/게임프로그래밍/파이게임/겜프프로젝트/진짜제출폴더임/음악파일/할로윈.mp3" )
    ...
    # 피통
        ...
        #  running = False # 종료 코드
        screen.blit(background, (background_x1,-400)) # 배경 그리기(background 가 표시되는 위치)
        screen.blit(background_left, (background_x, -400))

...
position = (300,500)
# 배경 이미지 불러오기
background = pygame.image.load("/Users/imin-ug/Python/게임프로그래밍/파이게임/겜프프로젝트/게임리소스/던전수정본.png")
...
#포탈을 불러옴
potal_2 = potal.AnimatedSprite(position=(1000,600))
potal = potal.AnimatedSprite(position=(1900,600))



all_sprites = pygame.sprite.Group(potal,potal_2,player)
enemy_sprites =pygame.sprite.Group(zombi,emeny1,ice_golem,abc)
    ...
    # 피통
        ...
        if  k_up_DF == True:        
            if player.rect.colliderect(potal.rect): 
                    ...
                    제출용2.main()
                    pygame.quit()
            if player.rect.colliderect(potal_2.rect):
                좀비맵.main()
                pygame.quit()

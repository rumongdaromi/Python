...
lose =pygame.image.load('/Users/imin-ug/Python/게임프로그래밍/파이게임/겜프프로젝트/lose.png')
lose_img = pygame.transform.scale(lose, (300,150))
gameDisplay = pygame.display.set_mode((900,900))
pygame.display.set_caption("민욱플스토리")
...
def mainmenu():
    ...
    while menu:
        ...
        gameDisplay.blit(lose_img,(300,100))

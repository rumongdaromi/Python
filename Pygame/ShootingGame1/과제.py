...
background = pygame.image.load("/Users/imin-ug/Python/김연규/우주.png")
...
class PlayerShip(pygame.sprite.Sprite):
    def __init__(self):
        ...
        a = pygame.image.load("/Users/imin-ug/Python/김연규/ship.png")
...
class ZaminKoo(pygame.sprite.Sprite):
    def __init__(self):
        global zamin
        self.rect = pygame.Rect((350,0), (120,120))
        pygame.sprite.Sprite.__init__(self)
        zamin.append(pygame.image.load("/Users/imin-ug/Python/김연규/제목.png"))
        zamin.append(pygame.image.load("/Users/imin-ug/Python/김연규/제목 2.png"))
        zamin.append(pygame.image.load("/Users/imin-ug/Python/김연규/제목 3.png"))
        zamin.append(pygame.image.load("/Users/imin-ug/Python/김연규/제목 4.png"))
...
class Mob(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        a = pygame.image.load("/Users/imin-ug/Python/김연규/운석.png")
...
class item(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        a = pygame.image.load("/Users/imin-ug/Python/김연규/루난.jpg")
        self.image = pygame.transform.scale(a, (30, 40))
        self.color = random.choice([BLACK, BLUE, RED, GREEN1, YELLOW])
        self.rect = self.image.get_rect()
        self.rect.x = random.randrange(SCREEN_WIDTH - self.rect.width)
